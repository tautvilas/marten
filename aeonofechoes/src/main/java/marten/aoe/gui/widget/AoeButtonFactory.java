...
public class AoeButtonFactory {
    ...
    public static Button getEndTurnButton() {
        Button button = new Button(ImageCache.getImage(Path.SKIN_DATA_PATH + "end-turn.png"));
        BitmapFont buttonFont = FontCache.getFont(new Font("Arial", Font.PLAIN,
                12));
        button.setFont(buttonFont);
        button.setLabel("End turn");
        return button;
    }

    public static Button getMenuButton(String label) {
        Button button = new Button(ImageCache.getImage(Path.SKIN_DATA_PATH + "menu-button.png"));
        BitmapFont buttonFont = FontCache.getFont(new Font("Arial", Font.PLAIN,
                20));
        button.setFont(buttonFont);
