...
public abstract class TileLoader extends AgeScene {
    ...
    protected void loadMasks(String path) {
        ...
        ImageData mask_5_1 = ImageCache.getImage("mask-5-1");
        ImageData mask_5_2 = ImageCache.getImage("mask-5-2");
        ImageCache.addImage("msk-5-0", ImageTransformations.flip(mask_5_2));
        ImageCache.addImage("msk-5-1", mask_5_2);
        ImageCache.addImage("msk-5-2", ImageTransformations.flip(mask_5_1));
        ImageCache.addImage("msk-5-3", ImageTransformations.vflip(mask_5_2));
        ImageCache.addImage("msk-5-4", ImageTransformations.rotate(mask_5_2, 2));
        ImageCache.addImage("msk-5-5", mask_5_1);
