	...
	public int generate() {
		...
		for (Triangle triangle : triangles)
			for (Vertex vertex : triangle.getVertices()) {
				GL11.glTexCoord3d(vertex.textureCoordinates.r, vertex.textureCoordinates.s, vertex.textureCoordinates.t);
				GL11.glNormal3d(vertex.normal.x, vertex.normal.y, vertex.normal.z);
				GL11.glVertex3d(vertex.coordinates.x, vertex.coordinates.y, vertex.coordinates.z);
			}				
		GL11.glEnd();
		GL11.glEndList();
		return answer;
